...
addEventHandler("onClientResourceStop", resourceRoot, function()
	...
	setElementData(root, "cosmo_bone_attach_data", data, false)
end)

addEventHandler("onClientResourceStart", resourceRoot, function()
	local data = getElementData(root, "cosmo_bone_attach_data")
	if data then
		...
		setElementData(root, "cosmo_bone_attach_data", nil, false)
	end
end)