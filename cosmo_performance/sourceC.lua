...
addEventHandler("onAssetsLoaded", getRootElement(),
	function ()
		if panelState or detailsState then
			...
			mainFont = exports.cosmo_assets:loadFont("CenturyGothicBold.ttf", respc(12), false, "cleartype")
			sarpFont = exports.cosmo_assets:loadFont("BebasNeue.otf", respc(18), false, "cleartype")
		end
	end
)

exports.cosmo_admin:addAdminCommand("fonts", 9, "Létrehozott betűtípusok adatai")
...
exports.cosmo_admin:addAdminCommand("performancelog", 7, "Játékos teljesítmény felmérés")
...
exports.cosmo_admin:addAdminCommand("performance", 7, "Teljesítmény statisztikák")
...
function dataRefresh()
	if detailsState then
		fontRows = exports.cosmo_assets:getFontsDetail()
		dataProcess()
...
function renderPerformance()
	...
	local titleWidth = dxGetTextWidth("#c10b0bKozma csabi pefomanc", 1, sarpFont, true) + 5

	dxDrawText("#c10b0bKozma csabi pefomanc", x + 5, y2, 0, y, whiteColor, 1, sarpFont, "left", "center", false, false, false, true)
