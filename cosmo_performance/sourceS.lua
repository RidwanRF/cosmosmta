...
addCommandHandler("performance",
	function (player, command, target)
		if getElementData(player, "acc.adminLevel") >= 7 and target then
			local targetPlayer, targetPlayerName = exports.cosmo_core:findPlayer(player, target)
...
exports.cosmo_admin:addAdminCommand("exports", 9, "Exportált funkciók listázása a konzolba")
