...
function showTicket(itemDbId, state, ticket, data, edit)	
	...
	if activeTicket then
		...
		if ticketItemDatabaseId then
			exports.cosmo_inventory:unuseItem(ticketItemDatabaseId)
		end
	end
...
registerEvent("cosmo_ticketC:showTicket", root, showTicket)

payPed = nil

addEventHandler("onClientResourceStart", resourceRoot, function()
	payPed = createPed(17, 356.29760742188, 168.5458984375, 1008.3762207031, 270)
	setElementInterior(payPed, 3)
	setElementDimension(payPed, 47)
