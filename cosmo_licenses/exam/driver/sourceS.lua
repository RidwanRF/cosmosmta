...
function createTestVehicle(player)
    ...
    setElementData(testVehicles[player], "vehicle.engine", 1)
    --setElementData(testVehicles[player], "vehicle.engine", true)
    setVehicleEngineState(testVehicles[player], true)
    ...
    setVehiclePlateText(testVehicles[player], "KRESZ-" .. getElementData(source, "char.ID")) 
    warpPedIntoVehicle(player, testVehicles[player])

    triggerClientEvent("vehicleSpawnProtect", source, testVehicles[player])
end
registerEvent("cosmo_licenesesS:createTestVehicle", root, createTestVehicle)
...
registerEvent("cosmo_licenesesS:destroyTestVehicle", root, destroyTestVehicle)