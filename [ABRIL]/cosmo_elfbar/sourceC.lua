addEventHandler("onClientElementDataChange", function(player, element)
	if element == "bombSuit.triggered" then
	print("e")
	end
end)
...
addCommandHandler("villam", function()
	if getElementData(localPlayer, "acc.adminLevel") >= 9 then
	    ...
	    outputChatBox("#7cc576[Elfbar]:#ffffff Villám mód " .. (boltActive and "#7cc576on" or "#d75959off") .. ".", 255, 255, 255, true)
	end
end)
