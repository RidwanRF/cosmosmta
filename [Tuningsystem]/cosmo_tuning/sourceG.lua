...
tuning_markers = {
	[1] = {
		pos = {2212.326171875, -1343.9702148438, 24.00245475769,90}, -- x,y,z,rot
		--logo = "textures/logo/los_santos.png",
	},
	[2] = {
		pos = {2219.5773925781, -1353.0604248047, 24.00245475769,270}, -- x,y,z,rot
		--logo = "textures/logo/los_santos.png",
	},
	[3] = {
		pos = {1643.8508300781, -1516.1737060547, 13.566598892212,0},
	},
	[4] = {
		pos = {2684.0017089844, -1100.4434814453, 69.324249267578,180},
	},
	[5] = {
		pos = {-1702.8386230469, 10.456907272339, 3.5546875,320},
	},
	[6] = {
		pos = {-1710.2431640625, 17.411769866943, 3.5728178024292,320},
	},
}
...
tuning_options = {
	...
	[1] = {name = "Teljesítmény",icon = "textures/icons/engine.dds",
		[1] = {name = "Motor",icon = "textures/icons/engine.dds",
			[1] = {name = "Légbeömlő",icon = "textures/icons/air_intake.dds",data="danihe->tuning->airintake",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/air_intake.dds",price=500000*0.2,priceType="Money",handling={"maxVelocity",1.5}},
				[3] = {name = "Profi csomag",icon = "textures/icons/air_intake.dds",price=1000000*0.6,priceType="Money",handling={"maxVelocity",3}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/air_intake.dds",price=1500000,priceType="Money",handling={"maxVelocity",4.5}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/air_intake.dds",price=500,priceType="PP",handling={"maxVelocity",5.5}},
			},
			[2] = {name = "Üzemanyagrendszer",icon = "textures/icons/fuel_system.dds",data="danihe->tuning->fuelsystem",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/fuel_system.dds",price=500000*0.2,priceType="Money",handling={"engineAcceleration",0.2}},
				[3] = {name = "Profi csomag",icon = "textures/icons/fuel_system.dds",price=1000000*0.6,priceType="Money",handling={"engineAcceleration",0.4}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/fuel_system.dds",price=1500000,priceType="Money",handling={"engineAcceleration",0.6}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/fuel_system.dds",price=500,priceType="PP",handling={"engineAcceleration",1}},
			},
			[3] = {name = "Gyújtás",icon = "textures/icons/ignite.dds",data="danihe->tuning->ignite",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/ignite.dds",price=500000*0.2,priceType="Money",handling={"engineAcceleration",0.15}},
				[3] = {name = "Profi csomag",icon = "textures/icons/ignite.dds",price=1000000*0.6,priceType="Money",handling={"engineAcceleration",0.3}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/ignite.dds",price=1500000,priceType="Money",handling={"engineAcceleration",0.45}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/ignite.dds",price=500,priceType="PP",handling={"engineAcceleration",0.75}},
			},
			[4] = {name = "Kipufogó",icon = "textures/icons/exhaust.dds",data="danihe->tuning->exhaust",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/exhaust.dds",price=500000*0.2,priceType="Money",handling={"engineAcceleration",0.2}},
				[3] = {name = "Profi csomag",icon = "textures/icons/exhaust.dds",price=1000000*0.6,priceType="Money",handling={"engineAcceleration",0.4}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/exhaust.dds",price=1500000,priceType="Money",handling={"engineAcceleration",0.6}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/exhaust.dds",price=500,priceType="PP",handling={"engineAcceleration",1}},
			},
			[5] = {name = "Vezérműtengely",icon = "textures/icons/camshaft.dds",data="danihe->tuning->camshaft",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/camshaft.dds",price=500000*0.2,priceType="Money",handling={"engineAcceleration",0.15}},
				[3] = {name = "Profi csomag",icon = "textures/icons/camshaft.dds",price=1000000*0.6,priceType="Money",handling={"engineAcceleration",0.3}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/camshaft.dds",price=1500000,priceType="Money",handling={"engineAcceleration",0.45}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/camshaft.dds",price=500,priceType="PP",handling={"engineAcceleration",0.75}},
			},
			[6] = {name = "Szelepek",icon = "textures/icons/valve.dds",data="danihe->tuning->valve",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/valve.dds",price=500000*0.2,priceType="Money",handling={"maxVelocity",2}},
				[3] = {name = "Profi csomag",icon = "textures/icons/valve.dds",price=1000000*0.6,priceType="Money",handling={"maxVelocity",4}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/valve.dds",price=1500000,priceType="Money",handling={"maxVelocity",6}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/valve.dds",price=500,priceType="PP",handling={"maxVelocity",7}},
			},
			[7] = {name = "Hengerűrtartalom",icon = "textures/icons/engine.dds",data="danihe->tuning->engine",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/engine.dds",price=500000*0.2,priceType="Money",handling={"maxVelocity",5}},
				[3] = {name = "Profi csomag",icon = "textures/icons/engine.dds",price=1000000*0.6,priceType="Money",handling={"maxVelocity",10}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/engine.dds",price=1500000,priceType="Money",handling={"maxVelocity",15}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/engine.dds",price=500,priceType="PP",handling={"maxVelocity",17}},
			},
			[8] = {name = "ECU",icon = "textures/icons/ecu.dds",data="danihe->tuning->ecu",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/ecu.dds",price=500000*0.2,priceType="Money",handling={"maxVelocity",3}},
				[3] = {name = "Profi csomag",icon = "textures/icons/ecu.dds",price=1000000*0.6,priceType="Money",handling={"maxVelocity",6}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/ecu.dds",price=1500000,priceType="Money",handling={"maxVelocity",9}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/ecu.dds",price=500,priceType="PP",handling={"maxVelocity",12}},
			},
			[9] = {name = "Dugattyúk",icon = "textures/icons/pistons.dds",data="danihe->tuning->pistons",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/pistons.dds",price=500000*0.2,priceType="Money",handling={"engineAcceleration",0.2}},
				[3] = {name = "Profi csomag",icon = "textures/icons/pistons.dds",price=1000000*0.6,priceType="Money",handling={"engineAcceleration",0.4}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/pistons.dds",price=1500000,priceType="Money",handling={"engineAcceleration",0.6}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/pistons.dds",price=500,priceType="PP",handling={"engineAcceleration",1.0}},
			},
			[10] = {name = "Turbó",icon = "textures/icons/turbo.dds",data="danihe->tuning->turbo",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/turbo.dds",price=500000*0.2,priceType="Money",handling={"engineAcceleration",0.5}},
				[3] = {name = "Profi csomag",icon = "textures/icons/turbo.dds",price=1000000*0.6,priceType="Money",handling={"engineAcceleration",1.0}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/turbo.dds",price=1500000,priceType="Money",handling={"engineAcceleration",1.5}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/turbo.dds",price=500,priceType="PP",handling={"engineAcceleration",2.5}},
				[6] = {name = "SC+Prémium csomag",icon = "textures/icons/turbo.dds",price=800,priceType="PP",handling={"engineAcceleration",2.8}},
			},
			[11] = {name = "Hőcserélő",icon = "textures/icons/intercooler.dds",data="danihe->tuning->intercooler",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/intercooler.dds",price=500000*0.2,priceType="Money",handling={"engineAcceleration",0.3}},
				[3] = {name = "Profi csomag",icon = "textures/icons/intercooler.dds",price=1000000*0.6,priceType="Money",handling={"engineAcceleration",0.6}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/intercooler.dds",price=1500000,priceType="Money",handling={"engineAcceleration",0.9}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/intercooler.dds",price=500,priceType="PP",handling={"engineAcceleration",1.5}},
			},
			[12] = {name = "Olajhűtés",icon = "textures/icons/oil_cooler.dds",data="danihe->tuning->oil_cooler",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/oil_cooler.dds",price=500000*0.2,priceType="Money",handling={"maxVelocity",1.2}},
				[3] = {name = "Profi csomag",icon = "textures/icons/oil_cooler.dds",price=1000000*0.6,priceType="Money",handling={"maxVelocity",2.4}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/oil_cooler.dds",price=1500000,priceType="Money",handling={"maxVelocity",3.6}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/oil_cooler.dds",price=500,priceType="PP",handling={"maxVelocity",5.0}},
			},
			[13] = {name = "Lendkerék",icon = "textures/icons/flywheel.dds",data="danihe->tuning->flywheel",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/flywheel.dds",price=500000*0.2,priceType="Money",handling={"maxVelocity",1.2}},
				[3] = {name = "Profi csomag",icon = "textures/icons/flywheel.dds",price=1000000*0.6,priceType="Money",handling={"maxVelocity",2.4}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/flywheel.dds",price=1500000,priceType="Money",handling={"maxVelocity",3.6}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/flywheel.dds",price=500,priceType="PP",handling={"maxVelocity",5.0}},
			},
		},
		[2] = {name = "Kezelhetőség",icon = "textures/icons/brakes.dds",
			[1] = {name = "Fékek",icon = "textures/icons/brakes.dds",data="danihe->tuning->brakes",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/brakes.dds",price=500000*0.2,priceType="Money",handling={"brakeDeceleration",4}},
				[3] = {name = "Profi csomag",icon = "textures/icons/brakes.dds",price=1000000*0.6,priceType="Money",handling={"brakeDeceleration",8}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/brakes.dds",price=1500000,priceType="Money",handling={"brakeDeceleration",12}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/brakes.dds",price=500,priceType="PP",handling={"brakeDeceleration",20}},
			},
			[2] = {name = "Lengéscsillapító",icon = "textures/icons/suspension.dds",data="danihe->tuning->suspension",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/suspension.dds",price=500000*0.2,priceType="Money",handling={"tractionMultiplier",0.008}},
				[3] = {name = "Profi csomag",icon = "textures/icons/suspension.dds",price=1000000*0.6,priceType="Money",handling={"tractionMultiplier",0.016}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/suspension.dds",price=1500000,priceType="Money",handling={"tractionMultiplier",0.024}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/suspension.dds",price=500,priceType="PP",handling={"tractionMultiplier",0.040}},
			},
			[3] = {name = "Alváz megerősítés",icon = "textures/icons/drivetype.dds",data="danihe->tuning->chassis",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/drivetype.dds",price=500000*0.2,priceType="Money",handling={"tractionMultiplier",0.007}},
				[3] = {name = "Profi csomag",icon = "textures/icons/drivetype.dds",price=1000000*0.6,priceType="Money",handling={"tractionMultiplier",0.014}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/drivetype.dds",price=1500000,priceType="Money",handling={"tractionMultiplier",0.021}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/drivetype.dds",price=500,priceType="PP",handling={"tractionMultiplier",0.035}},
			},
			[4] = {name = "Súlycsökkentés",icon = "textures/icons/weightreducation.dds",data="danihe->tuning->weight",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/weightreducation.dds",price=500000*0.2,priceType="Money",handling={"tractionLoss",0.007}},
				[3] = {name = "Profi csomag",icon = "textures/icons/weightreducation.dds",price=1000000*0.6,priceType="Money",handling={"tractionLoss",0.014}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/weightreducation.dds",price=1500000,priceType="Money",handling={"tractionLoss",0.021}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/weightreducation.dds",price=500,priceType="PP",handling={"tractionLoss",0.035}},
			},
			[5] = {name = "Gumik",icon = "textures/icons/tires.dds",data="danihe->tuning->tires",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/tires.dds",price=500000*0.2,priceType="Money",handling={"tractionMultiplier",0.03}},
				[3] = {name = "Profi csomag",icon = "textures/icons/tires.dds",price=1000000*0.6,priceType="Money",handling={"tractionMultiplier",0.06}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/tires.dds",price=1500000,priceType="Money",handling={"tractionMultiplier",0.09}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/tires.dds",price=500,priceType="PP",handling={"tractionMultiplier",0.15}},
			},
		},
		[3] = {name = "Hajtáslánc",icon = "textures/icons/drivetype.dds",
			[1] = {name = "Kuplung",icon = "textures/icons/clutch.dds",data="danihe->tuning->clutch",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/clutch.dds",price=500000*0.2,priceType="Money",handling={"engineAcceleration",0.15}},
				[3] = {name = "Profi csomag",icon = "textures/icons/clutch.dds",price=1000000*0.6,priceType="Money",handling={"engineAcceleration",0.3}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/clutch.dds",price=1500000,priceType="Money",handling={"engineAcceleration",0.45}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/clutch.dds",price=500,priceType="PP",handling={"engineAcceleration",0.75}},
			},
			[2] = {name = "Sebességváltó",icon = "textures/icons/gear.dds",data="danihe->tuning->gear",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/gear.dds",price=500000*0.2,priceType="Money",handling={"engineAcceleration",0.25}},
				[3] = {name = "Profi csomag",icon = "textures/icons/gear.dds",price=1000000*0.6,priceType="Money",handling={"engineAcceleration",0.5}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/gear.dds",price=1500000,priceType="Money",handling={"engineAcceleration",0.75}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/gear.dds",price=500,priceType="PP",handling={"engineAcceleration",1.25}},
			},
			[3] = {name = "Hajtáslánc",icon = "textures/icons/drivetype.dds",data="danihe->tuning->chain",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/drivetype.dds",price=500000*0.2,priceType="Money",handling={"engineAcceleration",0.2}},
				[3] = {name = "Profi csomag",icon = "textures/icons/drivetype.dds",price=1000000*0.6,priceType="Money",handling={"engineAcceleration",0.4}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/drivetype.dds",price=1500000,priceType="Money",handling={"engineAcceleration",0.6}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/drivetype.dds",price=500,priceType="PP",handling={"engineAcceleration",1.0}},
			},
			[4] = {name = "Differenciálmű",icon = "textures/icons/diff.dds",data="danihe->tuning->diff",
				...
				[2] = {name = "Utcai csomag",icon = "textures/icons/diff.dds",price=500000*0.2,priceType="Money",handling={"tractionMultiplier",0.007}},
				[3] = {name = "Profi csomag",icon = "textures/icons/diff.dds",price=1000000*0.6,priceType="Money",handling={"tractionMultiplier",0.014}},
				[4] = {name = "Verseny csomag",icon = "textures/icons/diff.dds",price=1500000,priceType="Money",handling={"tractionMultiplier",0.021}},
				[5] = {name = "Prémium csomag",icon = "textures/icons/diff.dds",price=500,priceType="PP",handling={"tractionMultiplier",0.035}},
			},
		},
	},
	...
	[4] = {name = "Extrák",icon = "textures/icons/extras.dds",
		[1] = {name = "Fordulókör",icon = "textures/icons/steering.dds",
			[1] = {name = "30°",icon = "textures/icons/steering.dds",price=0,priceType="Money",steer=30},
			[2] = {name = "35°",icon = "textures/icons/steering.dds",price=1500000,priceType="Money",steer=35},
			[3] = {name = "40°",icon = "textures/icons/steering.dds",price=1500000,priceType="Money",steer=40},
			[4] = {name = "45°",icon = "textures/icons/steering.dds",price=1500000,priceType="Money",steer=45},
			[5] = {name = "50°",icon = "textures/icons/steering.dds",price=1500000,priceType="Money",steer=50},
			[6] = {name = "55°",icon = "textures/icons/steering.dds",price=1500000,priceType="Money",steer=55},
			[7] = {name = "60°",icon = "textures/icons/steering.dds",price=1500000,priceType="Money",steer=60},
		},
		[2] = {name = "Rendszámtábla",icon = "textures/icons/plate.dds",plate=true,
		...
		[3] = {name = "Meghajtás",icon = "textures/icons/drivetype.dds",
			...
			--[4] = {name = "Drivetype beszerelés",icon = "textures/icons/drivetype.dds",price=600,priceType="PP",drivetype="drivetypeADD"},
		},
		[4] = {name = "Variáns",icon = "textures/icons/variant.dds",variant=true,
			[1] = {name = "Variáns #1",icon = "textures/icons/variant.dds",price=600,priceType="PP"},
			[2] = {name = "Variáns #2",icon = "textures/icons/variant.dds",price=600,priceType="PP"},
			[3] = {name = "Variáns #3",icon = "textures/icons/variant.dds",price=600,priceType="PP"},
			[4] = {name = "Variáns #4",icon = "textures/icons/variant.dds",price=600,priceType="PP"},
			[5] = {name = "Variáns #5",icon = "textures/icons/variant.dds",price=600,priceType="PP"},
			[6] = {name = "Variáns #6",icon = "textures/icons/variant.dds",price=600,priceType="PP"},
			[7] = {name = "Variáns #7",icon = "textures/icons/variant.dds",price=600,priceType="PP"},
			[8] = {name = "Variáns #8",icon = "textures/icons/variant.dds",price=600,priceType="PP"},
		},
		[5] = {name = "Paintjobs",icon = "textures/icons/stickers.dds",matrica=true,
			[1] = {name = "Paintjob #1",icon = "textures/icons/stickers.dds",price=900,priceType="PP"},
			[2] = {name = "Paintjob #2",icon = "textures/icons/stickers.dds",price=900,priceType="PP"},
			[3] = {name = "Paintjob #3",icon = "textures/icons/stickers.dds",price=900,priceType="PP"},
			[4] = {name = "Paintjob #4",icon = "textures/icons/stickers.dds",price=900,priceType="PP"},
			[5] = {name = "Paintjob #5",icon = "textures/icons/stickers.dds",price=900,priceType="PP"},
			[6] = {name = "Paintjob #6",icon = "textures/icons/stickers.dds",price=900,priceType="PP"},
			[7] = {name = "Paintjob #7",icon = "textures/icons/stickers.dds",price=900,priceType="PP"},
			[8] = {name = "Paintjob #8",icon = "textures/icons/stickers.dds",price=900,priceType="PP"},
			[9] = {name = "Paintjob #9",icon = "textures/icons/stickers.dds",price=900,priceType="PP"},
			[10] = {name = "Paintjob #10",icon = "textures/icons/stickers.dds",price=900,priceType="PP"},
			[11] = {name = "Paintjob #11",icon = "textures/icons/stickers.dds",price=900,priceType="PP"},
			[12] = {name = "Paintjob #12",icon = "textures/icons/stickers.dds",price=900,priceType="PP"},
			[13] = {name = "Paintjob #13",icon = "textures/icons/stickers.dds",price=900,priceType="PP"},
		},
		[6] = {name = "Facelifts",icon = "textures/icons/lamp.dds",facelift=true,
			--cameraSettings = {"boot_dummy", -45, 22, 4, true},
			[1] = {name = "Facelift #1",icon = "textures/icons/lamp.dds",price=1200,priceType="PP"},
			[2] = {name = "Facelift #2",icon = "textures/icons/lamp.dds",price=1200,priceType="PP"},
			[3] = {name = "Facelift #3",icon = "textures/icons/lamp.dds",price=1200,priceType="PP"},
			[4] = {name = "Facelift #4",icon = "textures/icons/lamp.dds",price=1200,priceType="PP"},
			[5] = {name = "Facelift #5",icon = "textures/icons/lamp.dds",price=1200,priceType="PP"},
		},
		[7] = {name = "Wheeltextures",icon = "textures/icons/rim.dds",wheeltexture=true,
			--cameraSettings = {"boot_dummy", -45, 22, 4, true},
			[1] = {name = "Kerékmatrica #1",icon = "textures/icons/rim.dds",price=1200,priceType="PP"},
			[2] = {name = "Kerékmatrica #2",icon = "textures/icons/rim.dds",price=1200,priceType="PP"},
			[3] = {name = "Kerékmatrica #3",icon = "textures/icons/rim.dds",price=1200,priceType="PP"},
			[4] = {name = "Kerékmatrica #4",icon = "textures/icons/rim.dds",price=1200,priceType="PP"},
			[5] = {name = "Kerékmatrica #5",icon = "textures/icons/rim.dds",price=1200,priceType="PP"},
			[6] = {name = "Kerékmatrica #6",icon = "textures/icons/rim.dds",price=1200,priceType="PP"},
			[7] = {name = "Kerékmatrica #7",icon = "textures/icons/rim.dds",price=1200,priceType="PP"},
		},
		[8] = {name = "Nitro",icon = "textures/icons/nitro.dds",data="danihe->tuning->nitro",
			...
			[2] = {name = "Beszerelés",icon = "textures/icons/nitro.dds",price=2000,priceType="PP"},
			[3] = {name = "Palack feltöltése",icon = "textures/icons/nitro.dds",price=800000,priceType="Money"},
 		},
 		[9] = {name = "Drivetype",icon = "textures/icons/drivetype.dds",data="danihe->tuning->drivetype",
			--cameraSettings = {"boot_dummy", -45, 22, 4, true}, -- komponens, x, y, zoom, eltüntés
			[1] = {name = "Kiszerelés",icon = "textures/icons/drivetype.dds",price=0,priceType="Money"},
			[2] = {name = "Beszerelés",icon = "textures/icons/drivetype.dds",price=2000,priceType="PP"},
 		},
 		[10] = {name = "Airride",icon = "textures/icons/airride.dds",data="danihe->tuning->airride",
			--cameraSettings = {"boot_dummy", -45, 22, 4, true}, -- komponens, x, y, zoom, eltüntés
			--cameraSettings = {"wheel_lf_dummy", 220, 15, 3, false}, -- komponens, x, y, zoom, eltüntés
			cameraSettings = {"wheel_lf_dummy", 180, 10, 1.3, true}, -- komponens, x, y, zoom, eltüntés
			[1] = {name = "Kiszerelés",icon = "textures/icons/airride.dds",price=0,priceType="Money"},
			[2] = {name = "Beszerelés",icon = "textures/icons/airride.dds",price=2000,priceType="PP"},
 		},
 		[11] = {name = "Backfire",icon = "textures/icons/exhaust.dds",data="danihe->tuning->backfire",
			--cameraSettings = {"boot_dummy", -45, 22, 4, true}, -- komponens, x, y, zoom, eltüntés
			--cameraSettings = {"wheel_lf_dummy", 220, 15, 3, false}, -- komponens, x, y, zoom, eltüntés
			cameraSettings = {"bump_rear_dummy", -105, 10, 3, true}, -- komponens, x, y, zoom, eltüntés
			[1] = {name = "Kiszerelés",icon = "textures/icons/exhaust.dds",price=0,priceType="Money"},
			[2] = {name = "Beszerelés",icon = "textures/icons/exhaust.dds",price=2000,priceType="PP"},
 		},
	},
}
