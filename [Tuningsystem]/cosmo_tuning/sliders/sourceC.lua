				...
				if row then
					...
					if row.type == "slider" then
						...
						if row.image then
							...
							local slider_pos = (boxS[1]-30-4)*row.data
							dxDrawRectangle(boxP[1]+15,boxP[2]+boxS[2]-20,(boxS[1]-30)*row.data,10,tocolor(124, 197, 118,255))
							dxDrawRectangle(boxP[1]+15+slider_pos,boxP[2]+boxS[2]-20-5,4,10+10,tocolor(255,255,255,255))
						end
					elseif row.type == "switch" then
						...
						if row.data == 0 then
							...
							dxDrawCircleRectangle(boxP[1]+boxS[1]-5-44+22+1,boxP[2]+boxS[2]/2-22/2+1,20,20,tocolor(124, 197, 118,255),10)
						end
					end
				end
			end
