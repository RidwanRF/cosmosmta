							...
							if clickTick + 500 <= getTickCount() then
								if absoluteX >= panelPosX + 5 and absoluteX <= panelPosX + 5 + panelWidth - 10 and absoluteY >= panelPosY + 40 and absoluteY <= panelPosY + 70 then
									...
									if radioState then
										...
										exports.cosmo_chat:sendLocalMeAction(localPlayer, "kikapcsolja a rádiót.")
									else
										setElementData(hifiElement, "radioState", 1)
										exports.cosmo_chat:sendLocalMeAction(localPlayer, "bekapcsolja a rádiót.")
									end
									panelState = false
								...
								elseif absoluteX >= panelPosX + 5 and absoluteX <= panelPosX + 5 + panelWidth - 10 and absoluteY >= panelPosY + 160 and absoluteY <= panelPosY + 190 then
									if getElementModel(hifiElement) == 2103 then
										...
										panelState = false
										playSound("files/hifibuttons.mp3", false)
										exports.cosmo_chat:sendLocalMeAction(localPlayer, "felveszi a rádiót a földről.")
										destroyFonts()
									else
										panelState = false
	...
	function ()
		...
		if panelState then
			if isElement(hifiElement) then
				...
				dxDrawRectangle(panelPosX + 3, panelPosY + 3, panelWidth - 6, 30, tocolor(0, 0, 0, 130))

				local stationText = "CosmoMTA - Rádió"
				local radioState = getElementData(hifiElement, "radioState")
				if radioState then
					if availableStations[radioState] then
				...
				dxDrawText(stationText, panelPosX + 5 + 3, panelPosY + 10, panelPosX + panelWidth - 2, panelPosY + 45, tocolor(255, 255, 255, 230), 0.8, panelFont, "left", "top", true, false, false, false, false)
				...
				drawButton3("toogleRadio", toggleText, panelPosX + 5, panelPosY + 40, panelWidth - 10, 30, toggleColor, false, panelFont, true)
				...
				drawButton3("nextStation", "Következő állomás", panelPosX + 5, panelPosY + 80, panelWidth - 10, 30, nextStationColor, false, panelFont, true)
				...
				drawButton3("prevStation", "Előző állomás", panelPosX + 5, panelPosY + 120, panelWidth - 10, 30, prevStationColor, false, panelFont, true)
				...
				drawButton3("pickUp", "Felvétel", panelPosX + 5, panelPosY + 160, panelWidth - 10, 30, pickupColor, false, panelFont, true)
				...
				drawButton3("close", "Bezárás", panelPosX + 5, panelPosY + 220, panelWidth - 10, 30, closeColor, false, panelFont, true)
