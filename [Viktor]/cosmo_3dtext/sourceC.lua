...
local textFont = dxCreateFont("files/opensans_semibold.ttf", 25, true)
									...
									if scaleFactor then
										...
										if textWidth then
											...
											if textHeight then
												...
												dxDrawRectangle(onScreenX - 6 - 3, onScreenY - 3 - 3, textWidth + 9 + 6, textHeight + 6 + 6, tocolor(0, 0, 0, 120))
												dxDrawRectangle(onScreenX - 6, onScreenY - 3, textWidth + 9, textHeight + 6, tocolor(0, 0, 0, 150))
											end
