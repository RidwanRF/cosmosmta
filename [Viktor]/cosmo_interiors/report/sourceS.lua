...
addEventHandler("onResourceStart", getResourceRootElement(),
	function ()
		...
		local pedElement = createPed(37, 1483.9040527344, -1777.28125, 0.89073371887207, 0)
					...
					if getDistanceBetweenPoints3D(playerX, playerY, playerZ, targetX, targetY, targetZ) <= 3 then
						...
						if nextInteriorReport and notReportedInteriors then
							...
							if interiorCount > 0 then
								...
								exports.cosmo_hud:showInfobox(source, "error", "Minden ingatlanod be van jelentve!")
							end
						else
							exports.cosmo_hud:showInfobox(source, "error", "Minden ingatlanod be van jelentve!")
						end
