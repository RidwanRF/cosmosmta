...
WaterWin = guiCreateWindow(x/2 - 127,y/2 - 70,254,140,"Viszint állítása",false)
...
LblCurrentLevel = guiCreateLabel(10,38,87,22,"Jelenlegi",false,WaterWin)
LblObjectiveLevel = guiCreateLabel(10,72,85,14,"Beállított",false,WaterWin)
guiLabelSetColor(LblObjectiveLevel,255,0,0)
BtnCancel = guiCreateButton(171,111,69,20,"Mégse",false,WaterWin)
BtnOk = guiCreateButton(95,111,69,20,"Mehet",false,WaterWin)
