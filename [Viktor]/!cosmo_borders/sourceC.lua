...
function isOfficer(player)
	return exports.cosmo_groups:isPlayerInGroup(player, 1) or exports.cosmo_groups:isPlayerInGroup(player, 4) or exports.cosmo_groups:isPlayerInGroup(player, 57) -- példa: or exports.cosmo_groups:isPlayerInGroup(player, 2) or exports.cosmo_groups:isPlayerInGroup(player, 2) or exports.cosmo_groups:isPlayerInGroup(player, 2)
end
...
-- 				--outputChatBox("#ff9428[CosmoMTA - Határ]:#ffffff Típus: #598ed7" .. exports.cosmo_vehiclenames:getCustomVehicleName(getElementModel(vehicle)) .. "#FFFFFF Színek: " .. rgbToHex(r1, g1, b1) .. "szín1 " .. rgbToHex(r2, g2, b2) .. "szín2", 255, 255, 255, true)
-- 			end
-- 		end
-- 	end)
