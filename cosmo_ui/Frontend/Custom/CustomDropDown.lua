...
function CustomDropDown.create(properties)
	...
	function widget:draw(animValue)
		...
		if not self.listDropped then
			Drawing.image(self.x, self.y + (self.height - iconSize) / 2, iconSize, iconSize, ":cosmo_assets/images/arrow.png", true, 0)
		else
			Drawing.image(self.x, self.y + (self.height - iconSize) / 2, iconSize, iconSize, ":cosmo_assets/images/arrow.png", true, 90)
		end
