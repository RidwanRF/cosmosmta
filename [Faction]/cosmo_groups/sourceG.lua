...
availablePermissions = {
	...
	weaponWarn = "Fegyver figyu adás /addfigyu",-- Kész
	illegalHirdetes = "Illegális hirdetés", -- Kész
	weaponShip = "Fegyverhajó", -- Kész
	atmRob = "ATM rablás", -- Kész
	gov = "Felhívás", -- Kész
	roadmarks = "Útfirkák felrajzolása", -- Kész
	craft = "Craft", -- kész
	cctv = "CCTV", -- kész
	--graffiti = "Graffiti", -- kész
}
