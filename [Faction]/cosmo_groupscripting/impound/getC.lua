...
addEventHandler("sarpUI.click", resourceRoot, function (widget, button)
	if button == "left" then
        ...
        elseif widget == widgets.getButton then
            ...
            triggerServerEvent("cosmo_impoundS:getVehicle", selectedItem[1], localPlayer, selectedItem[1], tonumber(selectedItem[2][2]))
			triggerServerEvent("setGroupBalance", localPlayer, 1, 6000000)
            Get.Close()
        end
	end
end)
