...
table.insert(availableJobs[1], {2001.5364990234, -1278.5892333984, 23.8203125 -1, 499, -1, "A takarításra szolgáló jármű.", false, "#000000", false})

table.insert(availableJobs[3], {-90.027954101562, -90.07063293457, 3.1171875 -1, 572, -1, "Kertészeknek való jármű.", false, "#ff9428", false})
