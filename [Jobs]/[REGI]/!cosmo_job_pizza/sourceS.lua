								...
								if getElementData(thePlayer, "char.Job") == jobID then
									...
									if getDistanceBetweenPoints3D(playerX, playerY, playerZ, targetX, targetY, targetZ) <= 3 then
										...
										if getElementData(source, "vehicle.jobID") ~= jobID then
											outputChatBox("#d75959[CosmoMTA - Pizzafutár]: #ffffffEz nem munkajármű.", thePlayer, 255, 255, 255, true)
											return
										end
										...
										if carryingPizza then
											...
											if pizzaBoyInventory then
												...
												exports.cosmo_chat:sendLocalMeAction(thePlayer, "berakott " .. #carryingPizza .. " darab pizzát a robogóba.")
											end
										else
						...
						if colData and colData[1] == thePlayer then
							...
							if carryingPizza[1] then
								...
								if carryingPizza[1] == currentJob.pizzas[orderId] then
									...
									exports.cosmo_core:giveMoney(thePlayer, 125000*3, "pizzaDelivered")
									...
									exports.cosmo_hud:showInfobox(thePlayer, "success", "Sikeresen leszállítottad a pizzát és kerestél 1250$-t!")
								else
									exports.cosmo_hud:showInfobox(thePlayer, "error", "Ez a megrendelő nem ilyen pizzát kért!")
								end
							end
						end
					end
