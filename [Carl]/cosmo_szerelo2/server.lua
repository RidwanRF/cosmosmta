...
addEventHandler("mechanic.applyAnimation",root,function(player,anim1,anim2,time,egy,ketto,harom)
    triggerClientEvent(root, "createMechanicSound", player,player)
    setPedAnimation(player,anim1,anim2,time,egy,ketto,harom);
end);

addEvent("mechanic.applyAnimation2",true);
addEventHandler("mechanic.applyAnimation2",root,function(sourcePlayer)
    setPedAnimation(sourcePlayer,"CARRY","liftup",1100,false,false,false,false)
end);
