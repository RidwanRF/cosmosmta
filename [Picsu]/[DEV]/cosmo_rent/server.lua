...
addEvent("createRentCar", true)
addEventHandler("createRentCar", getRootElement(),
	function(hitElement,kivalasztotJarmu)
		...
		count = count - 1
		theCar[hitElement] = createVehicle(kivalasztotJarmu,1473.8796386719, -1734.349609375, 13.3828125+1, 0, 0, 270, "RENT-" .. rentedPlateCount, false, 1, 1)
