...
function balanceQTEFail()
	...
	--if qte.balance.resource == "mta_weapons" then 
		--exports[qte.balance.resource]:addWeapon(1)
	...
	if qte.balance.resource == "cosmo_inventory" then 
...
function createProgressBar(progressTime)
	...
	qte.balance.timer = setTimer(function()
		...
		--if qte.balance.resource == "mta_weapons" then 
			--exports[qte.balance.resource]:addWeapon(2)
		--elseif qte.balance.resource == "mta_fishing" then 
