...
addEventHandler("onPlayerDamage", getRootElement(),
	function (attacker, weapon, bodyPart, loss)
		if getElementData(source, "char.nodmg") then
			print("asd")
			cancelEvent()
			return
		end
				...
				if math.random(chance) <= 7 then
					...
					if not boneDamages[boneName] then
						...
						if boneName == "leftArm" then
							exports.cosmo_hud:showInfobox(source, "warning", "Eltört a bal karod!")
						elseif boneName == "rightArm" then
							exports.cosmo_hud:showInfobox(source, "warning", "Eltört a jobb karod!")
						elseif boneName == "leftLeg" then
							exports.cosmo_hud:showInfobox(source, "warning", "Eltört a bal lábad!")
						elseif boneName == "rightLeg" then
							exports.cosmo_hud:showInfobox(source, "warning", "Eltört a jobb lábad!")
						end
					end
				end
			end
